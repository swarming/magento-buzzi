...
class Buzzi_Consume_Model_Config_Structure_ConfigGenerator
{
    /**
    ...
    public function generate($config)
    {
        ...
        /** @var Mage_Core_Model_Config_Element $consumeBuzziGroups */
        $consumeBuzziGroups = $config->getNode('sections/buzzi_consume_events/groups');
        ...
        foreach ($allTypes as $eventType) {
            ...
            $this->_generateEventGroup($consumeBuzziGroups, $eventType, $sortOrder);
        }
    ...
    protected function _generateEventGroup($configElement, $eventType, $sortOrder)
    {
        ...
        $this->_cronElementsGenerator->generate($fields, true, $sortOrder);
