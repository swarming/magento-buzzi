...
class Buzzi_PublishCustomerLogin_Model_DataBuilder
{
    const EVENT_TYPE = 'buzzi.ecommerce.user-login';
    ...
    public function getPayload($customer)
    {
        ...
        Mage::dispatchEvent('buzzi_publish_customer_login_payload', ['transport' => $transport]);
